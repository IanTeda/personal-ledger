...
- organise clauses consistently (SELECT, FROM, JOIN, WHERE, GROUP BY, HAVING, ORDER BY)
...
- return standardised error codes/messages
...
- parameterise all queries to prevent SQL injection
